# Создаю удобные веб-интерфейсы и серверные решения 👋

Я **Full Stack веб-разработчик** уровня Junior с фокусом на удобный UX/UI дизайн.  
Специализируюсь на создании комплексных веб-приложений: от проектирования интерфейсов до реализации серверной логики и API.
...
*   **Server Administration:** Администрирование высоконагруженных игровых серверов (Rust), работа с конфигурациями и плагинами.
