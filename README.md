...
| :--- | :--- | :--- |
| **[YouTubeDataZero](https://github.com/Wakanda1519/YouTubeDataZero)** | **Simple YouTube API Library.**<br>Легкая библиотека для получения статистики видео (просмотры, лайки, название). Официальный API v3, без зависимостей, умный парсинг ссылок. | ![PHP](https://img.shields.io/badge/PHP-7.4+-777bb4?style=flat-square) ![License](https://img.shields.io/badge/Zero_Dep-success?style=flat-square) |
